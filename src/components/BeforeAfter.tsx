      ...
      <div className="max-w-[1400px] mx-auto text-center">
        ...
        >
          ...
          <p className="text-[#737373] max-w-2xl mx-auto text-xl font-light leading-relaxed">
            Twoja biel i codzienny uśmiech dyktują poziom Twojej pewności siebie każdego dnia.
          </p>
        </motion.div>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-6xl mx-auto text-left">
          {/* Before - Przed wybielaniem */}
          <motion.div 
          ...
          >
             <div className="flex items-center gap-5 mb-10">
                ...
                <h3 className="text-3xl font-light text-[#1A1A1A]">Przed użyciem pasków</h3>
             </div>
             
              <ul className="space-y-8">
                <li className="flex flex-col gap-2">
                  <span className="font-semibold text-[#1A1A1A] text-lg">Utrata pewności siebie</span>
                  <span className="text-[#737373] font-light">Przebarwienia sprawiają, że rzadziej się uśmiechasz i czujesz skrępowanie w kontaktach z innymi ludźmi.</span>
                </li>
                <li className="flex flex-col gap-2">
                  <span className="font-semibold text-[#1A1A1A] text-lg">Ciemny osad i plamy</span>
                  <span className="text-[#737373] font-light">Twoje zęby stale przyjmują barwniki z kawy czy herbaty przez co tracą swój świetlisty blask i wyglądają niezdrowo.</span>
                </li>
              </ul>
           </motion.div>
           ...
           >
              ...
              <div className="flex items-center gap-5 mb-10 relative z-10">
                 ...
                 <h3 className="text-3xl font-medium text-[#1A1A1A]">Z GlowSmile</h3>
              </div>
              
              <ul className="space-y-8 relative z-10">
                <li className="flex flex-col gap-2">
                  <span className="font-semibold text-[#1A1A1A] text-lg">Śnieżnobiały uśmiech</span>
                  <span className="text-[#737373] font-light">Twoje zęby odzyskują naturalną jasność, przyciągając wzrok i dodając Ci pewności w każdej sytuacji.</span>
                </li>
                <li className="flex flex-col gap-2">
                  <span className="font-semibold text-[#1A1A1A] text-lg">Ochrona przed osadem</span>
                  <span className="text-[#737373] font-light">Aktywna formuła i idealne przyleganie zapewniają błyskawiczne pozbycie się osadu i wieloletnich uciążliwych plam.</span>
                </li>
                <li className="flex flex-col gap-2">
                  <span className="font-semibold text-[#1A1A1A] text-lg">Zdrowy i czysty wygląd</span>
                  <span className="text-[#737373] font-light">Pozbądź się matowego koloru i ciesz się efektem profesjonalnego wybielania bez wychodzenia z domu.</span>
                </li>
              </ul>
