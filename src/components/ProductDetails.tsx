...
const packages = [
  { id: 1, amount: 14, desc: "1 opakowanie (14 zabiegów)", price: "49,00", originalPrice: "79,90", unitPrice: "49,00 zł / opak.", popular: false, best: false },
  { id: 2, amount: 42, desc: "2 + 1 GRATIS (42 zabiegi)", price: "98,00", originalPrice: "147,00", unitPrice: "32,67 zł / opak.", popular: true, best: false },
  { id: 3, amount: 70, desc: "3 + 2 GRATIS (70 zabiegów)", price: "147,00", originalPrice: "245,00", unitPrice: "29,40 zł / opak.", popular: false, best: true },
];
      ...
      <div className="max-w-[1400px] mx-auto bg-white rounded-[40px] shadow-sm border border-[#E6E2DA] overflow-hidden flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-6 md:p-10 lg:p-16 flex flex-col justify-center bg-white">
          ...
          >
            ...
            <h1 className="text-4xl md:text-[52px] font-light text-[#1A1A1A] tracking-tight mb-6 leading-tight">GlowSmile</h1>
            <p className="text-[#737373] text-lg lg:text-xl font-light leading-relaxed mb-10 max-w-xl">
              Nowoczesny sposób na domowe wybielanie zębów. Sprawdzona formuła, która perfekcyjnie redukuje przebarwienia z kawy i wina.
            </p>
            ...
            <div className={`mb-8 -mt-4 transition-all duration-300 ${selectedPack.amount <= 14 ? 'opacity-70' : 'opacity-100'}`}>
              <span className={`text-[#1A1A1A] text-sm font-bold uppercase tracking-[0.1em] ${selectedPack.amount > 14 ? 'underline decoration-[#1A1A1A] decoration-2 underline-offset-8' : ''}`}>
                {selectedPack.amount <= 14 ? '+ Dostawa: 14,90 zł' : '+ Darmowa dostawa'}
              </span>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-y-6 gap-x-4 pt-8 border-t border-[#EAE6DF]">
              <div className="flex items-center gap-3 text-[11px] lg:text-xs font-bold uppercase tracking-widest text-[#1A1A1A]">
                ...
                <span className="underline decoration-2 underline-offset-4">Błyskawiczna wysyłka</span>
              </div>
        ...
        <div className="bg-white p-8 lg:p-12 rounded-[40px] border border-[#E6E2DA] shadow-sm flex flex-col justify-center">
          ...
          <ul className="space-y-6">
            <li className="flex items-start gap-4">
              ...
              <span className="text-[#404040] text-base font-light leading-relaxed">Zaawansowana technologia Dry Strip – gwarancja idealnego przylegania, dzięki czemu pasek ani drgnie podczas noszenia.</span>
            </li>
            <li className="flex items-start gap-4">
              <div className="mt-1 w-6 h-6 rounded-full bg-[#F7F6F4] flex items-center justify-center flex-shrink-0">
                <Check className="w-3.5 h-3.5 text-[#1A1A1A]" strokeWidth={2} />
              </div>
              <span className="text-[#404040] text-base font-light leading-relaxed">Systematycznie zmniejsza mocne plamy widoczne po nadmiarze kawy, ciemnej herbaty i dymu papierosowego.</span>
            </li>
            <li className="flex items-start gap-4">
              <div className="mt-1 w-6 h-6 rounded-full bg-[#F7F6F4] flex items-center justify-center flex-shrink-0">
                <Check className="w-3.5 h-3.5 text-[#1A1A1A]" strokeWidth={2} />
              </div>
              <span className="text-[#404040] text-base font-light leading-relaxed">Wybielanie całkowicie dopasowane do domowych warunków bez nadpotrzeby wizyty w gabinecie stomatologa.</span>
            </li>
          </ul>
        </div>
        ...
        <div id="reviews" className="bg-[#1A1A1A] p-8 lg:p-12 rounded-[40px] border border-[#2D2D2D] shadow-2xl flex flex-col justify-center text-white relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[#A3A3A3] text-base font-light italic leading-relaxed">"Rewelacja! Czułam efekt już po dwóch użyciach. Na dodatek wcale mnie nie bolały dziąsła ani szkliwo się nie uwrażliwiło na zimną wodę."</p>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p className="text-[#A3A3A3] text-base font-light italic leading-relaxed">"O wiele skuteczniejsze niż tanie alternatywy z apteki. Różnicę widać gołym okiem. Zawsze miałem problem przez poranną kawkę - teraz już go nie mam."</p>
